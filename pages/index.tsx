    ...
    <Container>
      <div className="flex flex-col items-start justify-center max-w-2xl mx-auto mb-16">
        ...
        <div className="grid-rows-4 grid-flow-col gap-4">
          ...
          <ProjectCard
            title="Simple Note"
            description="Inspired by The Sephist to create my own note taking app."
        ...
        <div className="flex flex-col gap-6 md:flex-row">
          <Link href="/blog/style-guides-component-libraries-design-systems">
            <a className="transform hover:scale-[1.01] transition-all rounded-xl w-full md:w-1/3 bg-gradient-to-r p-1 from-[#D8B4FE] to-[#818CF8]">
              <div className="flex flex-col h-full p-4 bg-white rounded-lg dark:bg-gray-900">
                <div className="flex flex-col justify-between md:flex-row">
                  <h4 className="w-full text-lg font-medium tracking-tight text-gray-900 md:text-lg dark:text-gray-100">
                    Fullstack development
                  </h4>
                </div>
                <div className="flex items-center text-gray-800 dark:text-gray-300 capsize"></div>
              </div>
            </a>
          </Link>
          <Link href="/blog/rust">
          ...
          <Link href="/blog/react-state-management">
