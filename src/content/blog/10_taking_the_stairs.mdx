...
- Building comfort with not knowing the answer yet
- Developing debugging instincts that only come from being stuck
- Stumbling into adjacent problems that turn out to matter
- Actually understanding the answer when you finally find it
...
Try this for the next 72 hours: when you hit a programming problem, before searching or asking AI:
...
4. Only then, if still stuck, seek help
...
The most useful things I learned from programming -- how to debug, how to think about systems, how to sit with a problem until it makes sense -- came from the times I couldn't immediately find the answer. LLMs are useful. They're not a replacement for that.
