...
One of the pitfalls of starting out as a software developer is not thinking about the _unhappy path_. As you further along in your career as a developer you encounter more cases where things aren't working as expected. Where you delve into the realm of things going wrong without knowing how.
