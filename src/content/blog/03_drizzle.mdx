...
I want to create a many-to-many relationship between these tables. At first you have to create the junction table yourself. Now that is not a big issue but still a little obstacle. Let's do that.
