...
<!-- TODO: cleanup code -->
  <div class="SideScrollArea-content--below-medium">
    <ul class="bui-Tabs bui-Tabs--bubble" data-bui-tabs-droplets-manage="" data-pushstate-ignore="">
      <router-link :to="{ name: 'AboutMe'}" class="bui-Tabs--bubble-listItem bui-Tabs--bubble-listItemLink" tag="li">
        ...
        <span class="bui-Tabs-bubble-label">Over mij</span>
      </router-link>
      <router-link :to="{ name: 'WhatICan'}" class="bui-Tabs--bubble-listItem bui-Tabs--bubble-listItemLink" tag="li">
        <div class="bui-Tabs-bubble-icon">
        ...
        <span class="bui-Tabs-bubble-label">Wat ik kan</span>
      </router-link>
      <router-link :to="{ name: 'WhatIHaveLearned'}" class="bui-Tabs--bubble-listItem bui-Tabs--bubble-listItemLink" tag="li">
        <div class="bui-Tabs-bubble-icon">
        ...
        <span class="bui-Tabs-bubble-label">wat ik heb geleerd</span>
      </router-link>

      <router-link :to="{ name: 'WhatIHaveDone'}" class="bui-Tabs--bubble-listItem bui-Tabs--bubble-listItemLink" tag="li">
        <div class="bui-Tabs-bubble-icon">
        ...
        <span class="bui-Tabs-bubble-label">wat ik heb gedaan</span>
      </router-link>
...
.bui-Tabs.bui-Tabs--bubble .bui-Tabs-bubble-label {
  ...
  -ms-flex: 0 0 auto;
  flex: 0 0 auto;
  // font-family: Sailec-Medium, system-ui, -apple-system, BlinkMacSystemFont,
